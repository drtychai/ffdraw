(function stylusPaperContentScript() {
    ...
    function findElementWithHighestScrollHeight() {
        ...
        for (var elem of elems) {
            if (elem.scrollHeight == elem.scrollWidth && elem.scrollHeight == 1000000) {
                // handles stupidly made pages that break our overlay
                continue;
            }
    ...
    function initDrawMenu() {
        ...
        menu.innerHTML = `
          <ul>
            <li>
              <input type="color" id="stroke_color" name="stroke_color" value="black" />
              <label for="stroke_color">Stroke</label>
            </li>
            <li>
              <input type="range" id="stroke_width" name="stroke_width" value="20" min="1" max="100" />
